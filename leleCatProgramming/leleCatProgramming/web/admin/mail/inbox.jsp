...
<email:html title="收件箱" ctx="${ctx}" emailType="收件箱">
	<div class="col-sm-3">
	...
	<div class="col-sm-9 animated fadeInRight">
		<div class="mail-box-header">
			...
			<email:tools ctx="${ctx}" emailType="收件箱" />
		</div>
		<div class="mail-box">
						...
						<c:forEach items="${requestScope.emails}" var="email">
							<tr class="unread readSign">
								...
								<td class="mail-ontact">
									<a class="read" href="${ctx}/admin/email/seeDetail/detail?emailId=${email.key.emailId}&detailType=收件箱">${email.key.sender.name}</a>
								</td>
								<td class="mail-subject">
									<span class="readState label label-warning pull-right">${email.value}</span>
									<a class="read" href="${ctx }/admin/email/seeDetail/detail?emailId=${email.key.emailId}&detailType=收件箱">${email.key.emailTheme}</a>
								</td>
								<td align="center">
										${email.key.time}
								</td>
